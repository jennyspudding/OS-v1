    ...
    <div className="min-h-screen bg-[#FFF8F2] text-[#4A3B32]">
      ...
      <div className="bg-white mx-2 sm:mx-4 mt-2 sm:mt-4 rounded-lg shadow-sm mb-32 sm:mb-36">
              ...
              {!selectedLocation && (
                <div className="absolute inset-0 bg-[#d63384]/5 z-10 flex items-center justify-center pointer-events-none">
                  <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-[#d63384]/20 max-w-xs text-center">
                    ...
                    <div className="text-xs text-gray-600">Atau seret pin merah ke lokasi yang tepat</div>
                  </div>
                </div>
              )}
            ...
            {selectedLocation ? (
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="font-medium text-green-800 mb-1">✅ Lokasi Berhasil Dipilih!</div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="mb-3">
                    ...
                    <p className="text-xs text-blue-600">
                      Alamat sudah terisi otomatis berdasarkan pin yang Anda pilih. Anda bisa mengedit untuk menambah detail seperti nomor rumah, patokan, dll.
                    </p>
                  </div>
                  ...
                  <textarea
                    ...
                    placeholder="Contoh: Jl. Sudirman No. 123, dekat Starbucks, sebelah Bank BCA..."
                    rows={3}
                    required
                  />
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <p className="text-xs text-blue-600">
                      Alamat detail membantu kurir menemukan lokasi Anda dengan mudah
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-4 bg-amber-50 border border-amber-200 rounded-lg p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-amber-800 mb-1">⏳ Menunggu Anda memilih lokasi</div>
                    <div className="text-sm text-amber-700">
                      Silakan klik di peta atau seret pin merah untuk menentukan lokasi pengiriman yang tepat
                    </div>
                  </div>
                </div>
        ...
        {(isLoadingQuotation || deliveryQuotation || quotationError) && (
          <div className="px-3 sm:px-4 md:px-6 pb-4 mb-4">
